      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-4 py-8 relative">
        ...
        >
          ...
          <motion.p
            ...
            className="text-white/95 text-center text-lg mb-3 leading-relaxed font-medium"
          >
          ...
          <motion.p
            ...
            className="text-white/75 text-center text-sm mb-8"
          >
          ...
          <motion.button
            ...
            className="w-full py-4 px-8 rounded-full font-bold text-lg shadow-xl transition-all"
            style={{ 
              background: "white", 
              color: "hsl(280, 55%, 55%)" 
            }}
          ...
          <motion.img
            ...
            src={bunnyImg}
            alt="Bunny"
            className="absolute bottom-4 left-4 w-20 h-20 object-contain cursor-pointer"
          />
        </motion.div>
      </div>
    );
      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-4 py-8 relative overflow-hidden">
        ...
        >
          ...
          >
            ...
            {[...Array(10)].map((_, i) => (
              <motion.span
                ...
                style={{
                  top: `${50 + 50 * Math.sin((i * Math.PI * 2) / 10)}%`,
                  left: `${50 + 50 * Math.cos((i * Math.PI * 2) / 10)}%`,
          ...
          <motion.p
            ...
            animate={{ opacity: 1 }}
            transition={{ delay: 0.7 }}
            className="text-xl text-foreground/80 mb-8 max-w-md mx-auto leading-relaxed"
          >
          ...
          <motion.div
            ...
            className="glass-card-pink rounded-3xl p-8 mb-8 max-w-sm mx-auto"
          >
            <motion.p
              animate={{ y: [0, -5, 0] }}
              transition={{ duration: 2, repeat: Infinity }}
              className="font-script text-2xl text-foreground mb-2"
            >
              With all my love,
            </motion.p>
            <p className="font-display text-3xl font-bold text-primary">Forever Yours 💝</p>
          </motion.div>
